                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="card-box">
                                    <h4>Skills</h4>
                                    <form action="<?php echo base_url()?>Resume/UploadSkills" method="post">
                                    <section>
                                        <div class="form-group clearfix">
                                            <label class="col-lg-2 control-label " for="userName1">Skill Title</label>
                                            <div class="col-lg-4">
                                                <input class="form-control required" id="Name" name="title" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                            <label class="col-lg-2 control-label " for="password1"> Rate Your Skill</label>
                                            <div class="col-lg-4">
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="submit" name="saveskill" value="Save Information" class="btn btn-default">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <?php if(!empty($Table)){ foreach($Table as $EachTable){?>
                            <tr>
                                ...
                                <th><?php echo $EachTable->ranking; ?></th>
                                <th></th>
                                <th></th>
                                <th><a href="<?php echo base_url();?>Resume/Deleteskill/<?php echo $EachTable->id;?>"><i class="fa fa-trash"></i></a></th>
                            </tr>
                        <?php }} ?>
                        </tbody>
                    </table>
